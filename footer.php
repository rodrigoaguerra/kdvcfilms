    <div id="about" class="container-fluid">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive center-block" src="<?php echo get_template_directory_uri(); ?>/img/sobre-nos-3.jpg" alt="Nossa Equipe">
        </div>
      </div>
      ...
      <div class="col-md-6">   
        ...
        <div class="col-md-5 col-md-pull-7">
          <img class="featurette-image img-responsive center-block"  src="<?php echo get_template_directory_uri(); ?>/img/sobre-nos-2.jpg" alt="Generic placeholder image">
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">Sobre A Empresa</h2>
          <p class="lead">A KDVC Films está localizada na região de Curitiba, no estado do Paraná e atua dentro e fora do país. Pablo Rosa e Satoru Onuka, cineastas da KDVC Films colocam à disposição dos noivos seus mais de 7 anos de experiência contando histórias de amor. Conte a sua história através dos olhos dos grandes profissionais da KDVC Films e eternize seu momento</p>
        </div>
        <div class="col-md-5">
          <img class="featurette-image img-responsive center-block"  src="<?php echo get_template_directory_uri(); ?>/img/sobre-nos-1.jpg" alt="Generic placeholder image">
        </div>
      </div>
